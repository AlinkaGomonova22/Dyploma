...
import os
from New_Dyploma_Alina.pages.base_page import WebPage
from New_Dyploma_Alina.pages.elements import WebElement
from New_Dyploma_Alina.pages.elements import ManyWebElements
...
class Header(WebPage):
    ...
    def __init__(self, web_driver, url=''):
        if not url:
            url = os.getenv("HEADER") or 'https://goldapple.by/'

        super().__init__(web_driver, url)

    # кнопка поиска
    search_button = WebElement(xpath='//button[@class="header-tab-button header-tab-button_search"]')
